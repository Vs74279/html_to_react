											...
											<ul className="comment-tree list-unstyled">
												<li className="mb-5">
													<div className="comment-area-box">
														<img alt="" src="assets/images/blog/test1.jpg" className="img-fluid float-left mr-3 mt-2" />
												...
												<li>
													<div className="comment-area-box">
														<img alt="" src="assets/images/blog/test2.jpg" className="mt-2 img-fluid float-left mr-3" />
							...
							<div className="col-lg-4">
								<div className="sidebar-wrap">
									...
									<div className="sidebar-widget card border-0 mb-3">
										<img src="assets/images/blog/blog-author.jpg" alt="" className="img-fluid" />
									...
									<div className="sidebar-widget latest-post card border-0 p-4 mb-3">
										...
										<div className="media border-bottom py-3">
											<Link to="#"><img className="mr-4" src="assets/images/blog/bt-3.jpg" alt="" /></Link>
										...
										<div className="media border-bottom py-3">
											<Link to="#"><img className="mr-4" src="assets/images/blog/bt-2.jpg" alt="" /></Link>
											<div className="media-body">
										...
										<div className="media py-3">
											<Link to="#"><img className="mr-4" src="assets/images/blog/bt-1.jpg" alt="" /></Link>
											<div className="media-body">
