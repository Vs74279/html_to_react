			...
			<div className="row justify-content-between align-items-center">
				<div className="col-lg-2 col-md-4">
					<div className="header-top-socials text-center text-lg-left text-md-left">
						<Link to="https://www.facebook.com/themefisher" target="_blank" rel="noreferrer"><i className="ti-facebook"></i></Link>
						<Link to="https://twitter.com/themefisher" target="_blank" rel="noreferrer"><i className="ti-twitter"></i></Link>
						<Link to="https://github.com/themefisher/" target="_blank" rel="noreferrer"><i className="ti-github"></i></Link>
					</div>
				</div>
			  ...
			  <li className="nav-item dropdown">
			   ...
			   <li className="nav-item dropdown">
					...
					<ul className="dropdown-menu" aria-labelledby="dropdown05">
						...
						<li><Link className="dropdown-item" to="bolgsidebar">Blog with Sidebar</Link></li>
		...
		<div className="row">
			<div className="col-lg-9 col-md-10">
				<div className="block">
					...
					<Link to="#" target="_blank" rel="noreferrer" className="btn btn-main animated fadeInUp btn-round-full" >Get started<i className="btn-icon fa fa-angle-right ml-2"></i></Link>
				</div>
			</div>
		</div>
	</div>
			...
			<div className="row">
				<div className="col-lg-4 col-md-12 col-sm-12">
					<div className="copyright">
						&copy; Copyright Reserved to <span className="text-color">Megakit.</span> by <Link to="https://themefisher.com/" target="_blank" rel="noreferrer">Themefisher</Link>
					</div>
				</div>

				<div className="col-lg-4 col-md-12 col-sm-12">
					<div className="copyright">
					Distributed by  <Link to="https://themewagon.com/" target="_blank"  rel="noreferrer">Themewagon</Link>
					</div>
				</div>
