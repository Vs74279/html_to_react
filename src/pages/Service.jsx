      ...
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <ul className="list-inline">
            ...
            <li className="list-inline-item"><Link to="#" className="text-white-50">Our services</Link></li>
          </ul>
        </div>
      </div>
    </div>
		...
		<div className="cta-block p-5 rounded">
			<div className="row justify-content-center align-items-center ">
				...
				<div className="col-lg-4">
					<Link to="contact.html" className="btn btn-main btn-round-full float-right">Contact Us</Link>
				</div>
			</div>
		</div>
	</div>
